...
\centering \includegraphics[width=4.5in]{gas1_levels.png} \\
\includegraphics[width=4.5in]{gas5_levels.png}
...
\vspace{0.1in}
\centering \includegraphics[width=4.5in]{regressor_comp.png} 
